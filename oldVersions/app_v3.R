# updated version of app_v2.R; added 90-day percent of average precipitation
...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      div(class = "left-align", plotOutput("fireMap", width = "900px", height = "700px")),
